...
class KalmanFilter:
    ...
    def __init__(self, markers):
        ...
        self.Q_t = 50*np.eye(2) #30 on sim
        self.R_t = 0.01*np.eye(3)
        # YOUR CODE HERE
        self.x_t = np.array([[0],[0],[0]]) # state
        self.P_t = 10000*np.eye(3) # covariance, 10000 on sim
    ...
    def prediction(self, v, imu_meas):
        ...
        self.x_t_prediction = np.array([x_pred, y_pred, theta_pred])
